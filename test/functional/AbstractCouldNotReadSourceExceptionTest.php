...
/**
 * Tests {@see \Dhii\Modular\Locator\AbstractCouldNotReadSourceException}.
 */
class AbstractCouldNotReadSourceExceptionTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\\Modular\\Locator\\AbstractCouldNotReadSourceException';
     ...
     * @since [*next-version*]
     *
     * @return \Dhii\Modular\Locator\AbstractCouldNotReadSourceException
     */
